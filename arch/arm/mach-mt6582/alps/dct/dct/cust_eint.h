...
#define CUST_EINT_MT6333_PMIC_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
...
#define CUST_EINT_CHR_STAT_NUM              92
...
#define CUST_EINT_TOUCH_PANEL_NUM              117
